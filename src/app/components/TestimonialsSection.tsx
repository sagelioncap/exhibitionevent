...
const testimonials = [
{
  ...
  avatarAlt: 'Smiling woman with curly brown hair, warm neutral background, professional portrait',
  name: 'Mara Okonkwo',
  role: 'Art Director, Meridian Studio',
  quote: 'The most cohesive exhibition I\'ve attended in years. Every room felt intentional — not just filled with work, but curated with a point of view.',
...
},
{
  ...
  avatarAlt: 'Professional man with glasses and light beard, clean white background, studio portrait',
  name: 'James Whitfield',
  role: 'Independent Collector, Boston',
  quote: 'I came to browse and left with three acquisitions and a whole new network. The artist talks alone were worth the trip from Boston.',
...
},
{
  ...
  quote: 'The Night Market on Day 7 was absolutely electric. Watching artists create live while music played — I still think about it months later.',
...
},
{
  ...
  quote: 'We brought our entire team of 18 people. It sparked conversations about our own work that are still influencing how we design six months on.',
