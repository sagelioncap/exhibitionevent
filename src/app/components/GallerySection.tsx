...
const translateY = ['translate-y-4', 'translate-y-8', 'translate-y-2', '-translate-y-2', 'translate-y-4', 'translate-y-8'];
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-3 sm:gap-5 py-10">
            ...
            <div
              ...
              className={`cursor-pointer will-change-transform transition-all duration-700 ease-out
                ...
                `}
              style={{ boxShadow: activeIndex === idx ? '0 25px 50px -12px rgba(26,122,74,0.25)' : undefined }}>
